...
const S = {
  app:{display:'flex',flexDirection:'column',height:'100vh',background:'#78B7A0',color:'#fff',fontFamily:"'Nunito',sans-serif",overflow:'hidden'},
  ...
  main:{display:'flex',flex:1,overflow:'hidden',minHeight:0,height:0},
  ...
  footer:{padding:'6px 8px',borderTop:'1px solid rgba(255,255,255,0.2)',display:'flex',flexDirection:'column',gap:4,flexShrink:0,background:'rgba(0,0,0,0.25)',minHeight:'fit-content'},
